...
//            $newDate = new Date('y/m/d',$holiday);
    ...
    public function getHtml($categoryData)
    {
        if (!isset($categoryData['error'])) {
            $html = '<div class="row">';
            $html .= '<h2 class="wastetype">'. __('Um welche Abfallart handelt es sich?') .'</h2>';
            foreach ($categoryData[0] as $key => $category) {
                        ...
                        <div data-source="' . $category['url'] . '" class="category" id="' . $category['id'] . '">
                            <div class="categories-base">
                                ...
                                <div class="categories-name">
                                    <h4>' . utf8_encode($category['name']) . '</h4>
                                </div>
                            </div>
                            <div class="categories-more-info">
                                <a href="#" data-toggle="modal" data-target="#category' . $category['id'] .'">
                                   <span class="cat-info">i</span>
                                 </a>
                            </div>
                        </div>
                    </div>
                ...
                $html .= '
                        <button type="button" class="close" data-dismiss="modal">
                                ...
                                <path d="M0.773926 24L23.7739 1" stroke="#ffffff" stroke-width="4"></path>
                                <path d="M0.773926 1L23.7739 24" stroke="#ffffff" stroke-width="4"></path>
                            </svg>
                        </button>';
            ...
            $html .= '</div>';
            $html .= '<div id="container-types-answer" class="row"></div>';
...
//                $containerSize = $this->mappingSizes[$containerSize];
            ...
            $html .= '<div id="container-product" class="col-sm-12">
                        <div class="weiter-total">
                            ...
                            <span class="details">Weiter zu den Details</span> 
                            </a>  
                        </div>
